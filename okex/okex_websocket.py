...
def get_server_time():
    url = "https://www.ouyi.cc/api/general/v3/time"
...
# channels = ["index/ticker:BTC-USDT", "index/ticker:ETH-USDT", "index/ticker:ADA-USDT","index/ticker:XRP-USDT", "index/ticker:DOT-USDT"]
# 指数K线

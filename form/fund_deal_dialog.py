...
# Form implementation generated from reading form file 'fundDealDialog.form'
#
...
class Ui_FundDealDialog(object):
    def setupUi(self, FundDealDialog):
        ...
        self.allUnitsTxt.setMinimumSize(QtCore.QSize(0, 20))

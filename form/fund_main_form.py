...
"}")
        ...
        self.gridLayout_4.addWidget(self.coinPairText, 0, 1, 1, 1)
        self.addCoinPairBtn = QtWidgets.QPushButton(self.tab_3)
        self.addCoinPairBtn.setObjectName("addCoinPairBtn")
        self.gridLayout_4.addWidget(self.addCoinPairBtn, 0, 2, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.coinMarketTable, 1, 0, 1, 3)
